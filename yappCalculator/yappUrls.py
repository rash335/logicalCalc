...
urlpatterns = [
    ...
    path('logicalOperations/changeBinary', views.changeBinary,name='change binary'),
    path('logicalOperations/changeHexa',views.changeHexa,name='change hexa'),
    path('logicalOperations/allLogical', views.allLogical,name='all logical operations'),
]